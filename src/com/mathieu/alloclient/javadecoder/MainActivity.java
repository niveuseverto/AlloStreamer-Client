...
//        registerListeners();
		...
		Log.i("dbg","Main thread tid: " + tid);

		
        try{
            sender = new OSCPortOut(InetAddress.getByName("192.168.1.185"), 7000);
        }catch (Exception e){
...
//        new oscthread().execute("test");
		...
		preferenceServer = p.getString("URL", defaultServer);
...
//	            return true;
	...
	public void onResume()
	{
		...
		SharedPreferences p = PreferenceManager.getDefaultSharedPreferences(this);
		String defaultServer = this.getResources().getString(R.string.defaultServer);
		String newServer = p.getString("URL", defaultServer);
...
//			
		...
		@Override
		public void run() {
//			int tid2=android.os.Process.myTid();
//			Log.i("dbg","Decoder thread tid: " + tid2);
//			
//			Log.d("dbg","priority before change = " + android.os.Process.getThreadPriority(tid2));
//	        android.os.Process.setThreadPriority(tid2, -20/*android.os.Process.THREAD_PRIORITY_DISPLAY*/);
//	        Log.d("dbg","priority after change = " + android.os.Process.getThreadPriority(tid2));
...
//						format.setInteger(MediaFormat.KEY_FRAME_RATE, 30);
	...
	{	
		...
		public void run()
		{
//			int tid3=android.os.Process.myTid();
//			Log.i("dbg","Decoder thread tid: " + tid3);
//			
//			Log.d("dbg","priority before change = " + android.os.Process.getThreadPriority(tid3));
//	        android.os.Process.setThreadPriority(tid3, 15/*android.os.Process.THREAD_PRIORITY_DISPLAY*/);
//	        Log.d("dbg","priority after change = " + android.os.Process.getThreadPriority(tid3));
